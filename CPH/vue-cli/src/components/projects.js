  ...
  [
    {
      ...
      obj: 'Take engineering.com, a news site focused on topics relevant to professional engineers, and rebuild it using the existing ProjectBoard infrastructure based on Vue.js',
      role: 'Research, design, and build a new homepage and article page format. Create new personalization features, and rebuild the login and signup flow.',
      highlight: 'Refactoring the article footer to decrease the bounce rate and encourage users to read more stories based on recommendations.',
